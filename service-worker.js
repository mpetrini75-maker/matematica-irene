const CACHE = 'matematica-irene-v11';
...
const ASSETS = [
  ...
  './equazioni.html',
  './equazioni-allenamento.html',
  './equazioni-overview.mp3',
  './equazioni-infografica.png',
  './insiemi-logica.html',
  './insiemi-logica-allenamento.html',
  './insiemi-logica-overview.mp3',
  './insiemi-logica-infografica.png',
  './style.css',
  './app.js',
  './alert.js',
  './lightbox.js',
